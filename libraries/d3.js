...
var zoom = function() {
  ...
  function zoom(selection$$1) {
    selection$$1
      ...
      .filter(touchable$1)
        ...
        .on("touchend.currentZoomLevel touchcancel.zoom", touchended)
        .style("touch-action", "none")
        .style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  ...
  function schedule(transition$$1, transform$$1, center) {
    transition$$1
        ...
        .on("interrupt.currentZoomLevel end.zoom", function() { gesture(this, arguments).end(); })
        .tween("zoom", function() {
          var that = this,
              args = arguments,
              g = gesture(that, args),
  ...
  function mousedowned() {
    ...
    function mouseupped() {
      v.on("mousemove.currentZoomLevel mouseup.zoom", null);
